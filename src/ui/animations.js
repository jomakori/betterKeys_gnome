...
class BetterKeysAnimationManager extends GObject.Object {
    ...
    animateRipple(parent, x, y, options = {}) {
        const color = options.color || new Clutter.Color({ red: 100, green: 150, blue: 255, alpha: 100 });
    ...
    animateSwipe(parent, startX, startY, endX, endY, options = {}) {
        const color = options.color || new Clutter.Color({ red: 255, green: 200, blue: 0, alpha: 180 });
